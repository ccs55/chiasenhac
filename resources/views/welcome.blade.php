    ...
    <section>
      <!-- left side start-->
		<div class="left-side sticky-left-side">
			...
			<div class="logo">
				<h1><a href="index.html">ZaM</a></h1>
			</div>
			<div class="logo-icon text-center">
				<a href="index.html">ZaM </a>
			</div>
 	 <!-- /w3l-agile -->
			...
			<div class="left-side-inner">
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li><a href="band.html" ><i class="fa fa-th"></i><span>Band</span></a></li>
						<li><a href="artist.html"><i class="lnr lnr-users"></i> <span>Artists</span></a></li> 
						
						<li><a href="blog.html"><i class="lnr lnr-book"></i><span>Blog</span></a></li>
						
						<li class="menu-list"><a href="#"><i class="lnr lnr-heart"></i>  <span>My Favourities</span></a> 
							<ul class="sub-menu-list">
								<li><a href="favourist.html">All Songs</a></li>
							</ul>
						</li>
						...
						<div class="albums second">
										<div class="tittle-head">
											...
											<div class="col-md-3 content-grid">
												...
												<div class="inner-info"><a href="single.html"><h5>See now</h5></a></div>
											</div>
											<div class="col-md-3 content-grid">
