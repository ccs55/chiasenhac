...
<head>
	<title> ZaM - Music for life | Home</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<meta name="keywords" content="Music Website design" />
	...
	<section>
		...
		<div class="left-side sticky-left-side">
			...
			<div class="left-side-inner">
				...
				<ul class="nav nav-pills nav-stacked custom-nav">
					...
					<li><a href="{{ url('/radio') }}"><i class="camera"></i> <span>Radio</span></a></li>
					<li><a href="{{ url('/band') }}"><i class="fa fa-th"></i><span>Band</span></a></li>
					<li><a href="{{ url('/artist') }}"><i class="lnr lnr-users"></i> <span>Artists</span></a></li>

					<li><a href="{{ url('/blog') }}"><i class="lnr lnr-book"></i><span>Blog</span></a></li>

					<li class="menu-list"><a href="#"><i class="lnr lnr-heart"></i> <span>My Favourities</span></a>
						<ul class="sub-menu-list">
							<li><a href="{{ url('/favourite') }}">All Songs</a></li>
						</ul>
					</li>
					<li class="menu-list"><a href="{{ url('/contact ') }}"><i
								class="fa fa-thumb-tack"></i><span>Contact</span></a>
						<ul class="sub-menu-list">
		...
		<div id="page-wrapper">
				...
				<div class="music-left">
								...
								<ul class="rslides callbacks callbacks1" id="slider4">
									<li>
										...
										<div class="banner-info">
											<a class="trend" href="{{ url('/single ') }}">TRENDING</a>
											<h3>Let Your Home</h3>
					...
					<div class="albums second">
						...
						<div class="col-md-3 content-grid">
							...
							<div class="inner-info"><a href="{{ url('/single ') }}">
									<h5>See now</h5>
								</a></div>
						</div>
						<div class="col-md-3 content-grid">
								...
								<div class="jp-type-playlist">
									<div id="jquery_jplayer_1" class="jp-jplayer" style="width: 480px; height: 270px;">
										<img id="jp_poster_0" src="video/play1.png"
											style="width: 480px; height: 270px; display: inline;"><video id="jp_video_0"
											preload="metadata"
									...
									<div class="jp-playlist">
										<ul style="display: block;">
											...
											<li>
												<div><a href="javascript:;" class="jp-playlist-item-remove"
														style="display: none;">×</a><a href="javascript:;"
														class="jp-playlist-item" tabindex="0">3. Ellie-Goulding <span
											...
											<li>
												<div><a href="javascript:;" class="jp-playlist-item-remove"
														style="display: none;">×</a><a href="javascript:;"
														class="jp-playlist-item" tabindex="0">5. Pharrell-Williams <span
															class="jp-artist">by Pixar</span></a></div>
											</li>
											<li>
												<div><a href="javascript:;" class="jp-playlist-item-remove"
														style="display: none;">×</a><a href="javascript:;"
														class="jp-playlist-item" tabindex="0">6. Ellie-Goulding <span
															class="jp-artist">by Pixar</span></a></div>
											</li>
											<li>
												<div><a href="javascript:;" class="jp-playlist-item-remove"
														style="display: none;">×</a><a href="javascript:;"
														class="jp-playlist-item" tabindex="0">7. Pharrell-Williams <span
															class="jp-artist">by Pixar</span></a></div>
											</li>
										</ul>
									</div>
			...
			//]]>
					...
					<!--/app_store-->
					<div class="apps">
						<h3 class="hd-tittle">ZaM-Music now available in</h3>
		...
		<div class="footer">
			<div class="footer-grid">
				...
				<ul class="list1">
					...
					<li><a href="{{ url('/radio') }}">All Songs</a></li>
					<li><a href="{{ url('/album') }}">Albums</a></li>
					<li><a href="{{ url('/radio') }}">New Collections</a></li>
		...
		<footer>
			<p>&copy 2019 ZaM Music. All Rights Reserved | Design by <a href="https://w3layouts.com/"
					target="_blank">Angel & Friends.</a></p>
		</footer>
		<!--footer section end-->
		<!-- /w3l-agile -->
		<!-- main content end-->
