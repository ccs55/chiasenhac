...
<head>
  ...
  <title>@yield('title','ZAM Admin')</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{url('/')}}">
        ...
        <div class="sidebar-brand-text mx-3">ZAM Admin</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{url('/admin/song/create')}}">Thêm</a>
            <a class="collapse-item" href="{{url('/admin/song/')}}">Sửa</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Chọn:</h6>
            <a class="collapse-item" href="{{url('/admin/video/create')}}">Thêm</a>
            <a class="collapse-item" href="{{url('/admin/video/')}}">Sửa</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapse3" class="collapse" aria-labelledby="heading3" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Chọn:</h6>
          <a class="collapse-item" href="{{url('/admin/singer/create')}}">Thêm</a>
            <a class="collapse-item" href="{{url('/admin/singer/')}}">Sửa</a>
          </div>
        </div>
      </li>
