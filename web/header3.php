											  ...
											  <div class="col-md-4 player" style="left: 50px;">
													<div class="audio-player">
														...
														<audio id="audio-player"  controls="controls" autoplay>
																...
																<source src="media/<?php echo $key['Link'] ?>" type="audio/mpeg"></source>
...
<div style="color:white;height:250px;width:1079px;  margin-top: 2cm;background: url('student_image/hinhmo.jpg') center center / cover no-repeat;">
